...
open class ConfigKt(
    ...
    var version: @Range(from = 0L, to = 2147483647L) Int = 0
    var patches: Map<Int, UnaryOperator<JsonObject>> = mapOf()

    override fun build(parent: ResourcefulConfig?): ResourcefulConfig {
        val config = ParsedConfig(this.version, this.file, this.buildInfo(), this.entries, LinkedHashMap<String, ResourcefulConfig>(), this.buttons)
